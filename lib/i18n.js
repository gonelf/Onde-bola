...
export const I18N = {
  en: {
    ...
    seoP1: "<strong>Hoje Há Bola</strong> shows you every football (soccer) match being played around the world today and exactly <strong>which TV channels and streaming services are broadcasting them in your country</strong> — with live scores, kickoff times, venues and a clear free-to-air vs. paid breakdown for each match.",
    ...
    mdKickoff: "KICK-OFF", mdHalftime: "HALF-TIME", mdFulltime: "FULL-TIME", mdMiss: "MISSED",
  ...
  pt: {
    ...
    mdKickoff: "PONTAPÉ DE SAÍDA", mdHalftime: "INTERVALO", mdFulltime: "FIM DO JOGO", mdMiss: "FALHOU",
...
// Build a translator for a language, falling back to the English string.
export function makeT(lang) {
  const L = I18N[lang] || I18N.en;
  return function t(key) {
    return L[key] != null ? L[key] : I18N.en[key];
  };
}
