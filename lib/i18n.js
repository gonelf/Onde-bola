...
export const I18N = {
  en: {
    ...
    gestLabel: "Gestures", gestToggle: "Navigate with hand gestures (uses your camera)",
    gestLoading: "Starting camera…",
    gestNoCam: "Camera unavailable — check permissions.",
    gestNoModel: "Couldn’t load the gesture model. Check your connection.",
    gestPrev: "Previous day", gestNext: "Next day", gestToday: "Today", gestBack: "Back",
    gestHintSwipe: "Swipe open hand ← / → to change day",
    gestPrivacy: "Camera runs only while this is on — everything stays on your device, nothing is recorded.",
  },
  pt: {
    ...
    gestLabel: "Gestos", gestToggle: "Navegar com gestos das mãos (usa a câmara)",
    gestLoading: "A iniciar a câmara…",
    gestNoCam: "Câmara indisponível — verifica as permissões.",
    gestNoModel: "Não foi possível carregar o modelo de gestos. Verifica a ligação.",
    gestPrev: "Dia anterior", gestNext: "Dia seguinte", gestToday: "Hoje", gestBack: "Voltar",
    gestHintSwipe: "Desliza a mão aberta ← / → para mudar de dia",
    gestPrivacy: "A câmara só funciona enquanto isto está ligado — tudo fica no teu dispositivo, nada é gravado.",
  },
};
