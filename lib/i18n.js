...
export const I18N = {
  en: {
    ...
    tableShow: "Table", tableHide: "Hide table", tableAria: "Show competition table",
    tableLoading: "Loading table…", tableNone: "No table available for this competition.",
    nextGames: "Next games", championshipPage: "Championship page →",
    tblPos: "#", tblClub: "Club", tblP: "P", tblW: "W", tblD: "D", tblL: "L",
    tblGF: "GF", tblGA: "GA", tblGD: "GD", tblPts: "Pts",
    tblPlayedFull: "Played", tblWonFull: "Won", tblDrawnFull: "Drawn", tblLostFull: "Lost",
    tblGFFull: "Goals for", tblGAFull: "Goals against", tblGDFull: "Goal difference", tblPtsFull: "Points",
  ...
  pt: {
    ...
    tableShow: "Classificação", tableHide: "Ocultar classificação", tableAria: "Mostrar classificação da competição",
    tableLoading: "A carregar classificação…", tableNone: "Sem classificação disponível para esta competição.",
    nextGames: "Próximos jogos", championshipPage: "Página da competição →",
    tblPos: "#", tblClub: "Equipa", tblP: "J", tblW: "V", tblD: "E", tblL: "D",
    tblGF: "GM", tblGA: "GS", tblGD: "DG", tblPts: "P",
    tblPlayedFull: "Jogos", tblWonFull: "Vitórias", tblDrawnFull: "Empates", tblLostFull: "Derrotas",
    tblGFFull: "Golos marcados", tblGAFull: "Golos sofridos", tblGDFull: "Diferença de golos", tblPtsFull: "Pontos",
