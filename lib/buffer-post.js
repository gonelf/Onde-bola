...
// Per-platform `metadata` that Buffer requires beyond text+assets. Instagram
// needs a post type + feed flag (InstagramPostMetadataInput.type/shouldShareToFeed
// are non-null); the others we post to don't require any, so omit it.
