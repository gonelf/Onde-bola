 ...
 *
 * This lives in lib/ (not api/) so it stays a shared module rather than a
 * standalone Serverless Function — /api/share and /api/og import getCard()
 * directly. (Vercel's Hobby plan caps a deployment at 12 functions.)
 *
...
// Resolve + cache one card. Exported so the share page can reuse it directly
// (the image function fetches this endpoint over HTTP instead).
